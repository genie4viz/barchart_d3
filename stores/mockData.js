  ...
  tableSchemas: [
    {
      ...
      columns: [
        ...
        },
        {
          ...
          type: 'select',
          typeOptions: {
            choiceOrder: ['sel9x5rKHboeT0dAI', 'selmN1L92cRL0Io3T', 'sel2C7HnlYumw7pzK'],
            choices: {
              sel9x5rKHboeT0dAI: {
          ...
          cellValuesByColumnId: {
            ...
            fldfkfqIkvFPdywvf: [
              ...
              },
              {
                ...
                foreignRowDisplayName: 'Send form for allergies/dietary preferences',
              },
            ],
            fldjJ1vL9kvN3X1GD: 'sel9x5rKHboeT0dAI',
            fldweth4BhXFTb5ni: 'Q1 Team Outing!',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        typeOptions: null,
        values: [null, null, null, 'Exponents', 'dollars for students enrolled in', 'Λ'],
      },
      {
        name: 3,
        type: 'text',
